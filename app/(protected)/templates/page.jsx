'use client';
// app/(protected)/templates/page.jsx - 话术库管理页
...
const CATEGORY_OPTIONS = [
  { value: 'general', label: '通用' }, { value: 'weekly', label: '周报' },
  { value: 'monthly', label: '月报' }, { value: 'standup', label: '晨会' },
...
export default function TemplatesPage() {
  ...
  const openCreate = () => { setEditingTemplate(null); form.resetFields(); setModalOpen(true); };
  const openEdit = (record) => { setEditingTemplate(record); form.setFieldsValue(record); setModalOpen(true); };
  ...
  const columns = [
    { title: '序号', key: 'index', width: 60, align: 'center', render: (_, __, i) => (tablePage - 1) * tablePageSize + i + 1 },
